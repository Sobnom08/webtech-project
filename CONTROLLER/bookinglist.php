            ...
            <?php while($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <?php if($row['confirmation'] == 0 or $row['finished'] == 1) { ?>
                        <td><a  href="releasebooking.php?id=<?php echo $row['booking_id']; ?>">Release Vehicle</a></td>
                    <?php } else { ?>
                        <td><a  href="releasebooking.php?id=<?php echo $row['booking_id']; ?>">Release Vehicle</a></td>
                    <?php } ?>
                    <?php if($row['confirmation'] == '0') { ?>
                        <td><a  href="confirmbooking.php?id=<?php echo $row['booking_id']; ?>">Confirm</a></td>
                    <?php } else { ?>
                        <td><a  href="confirmbooking.php?id=<?php echo $row['booking_id']; ?>">Confirm</a></td>
                    <?php } ?>
                    <?php if($row['confirmation'] == '0') { ?>
                    ...
                    <?php if($row['finished'] == '1' and $row['paid'] == 0) { ?>
                        <td><a  href="bill.php?id=<?php echo $row['booking_id']; ?>">Bill</a></td>
